...
//           <div className="corner-frame bg-navy-800/60  px-7 py-8 sm:px-10 sm:py-10 max-w-md w-full">
...
//               <button
//                 type="submit"
//                 className="w-full bg-[#C9A24B] hover:bg-gold-light text-navy px-7 py-3.5 text-xs tracking-widest2 uppercase font-medium transition-colors shadow-sm hover:shadow-md"
//               >
//                 Submit Enquiry
//               </button>
//             </form>
//             {submitted && (
//               <p className="mt-4 text-sm text-green text-center">
