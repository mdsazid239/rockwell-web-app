...
//     image: "/images/lobby-entrance.jpg",
...
const sections = [
  ...
  },
  {
    ...
    tagline:
      "Because reputation is often established before the first meeting begins.",
    image: "/images/lobby-entrance.jpg",
    imageAlt: "11:11 Business Park grand lobby entrance",
    imageSide: "right",
  },
  {
    ...
    tagline:
      "Because great workplaces give great ideas room to grow.",
    image: "/images/boardroom.jpg",
    imageAlt: "11:11 Business Park boardroom with skyline view",
    imageSide: "left",
  },
  ...
  return (
    <div id="overview">
      {sections.map((section) => (
        <SplitSection key={section.heading} {...section} />
      ))}
    </div>
  );
}